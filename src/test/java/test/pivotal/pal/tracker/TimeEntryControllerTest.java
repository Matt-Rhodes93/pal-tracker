...
public class TimeEntryControllerTest {
    ...
    public void testCreate() throws Exception {
        ...
        verify(counterService).increment("TimeEntry create");
        verify(gaugeService).submit("timeEntries count", timeEntryRepository.list().size());
    ...
    public void testUpdate() throws Exception {
        ...
        verify(counterService).increment("TimeEntry update");
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isEqualTo(expected);
    }
    ...
    public void testDelete() throws Exception {
        ...
        verify(counterService).increment("TimeEntry delete");
        verify(gaugeService).submit("timeEntries count", timeEntryRepository.list().size());
